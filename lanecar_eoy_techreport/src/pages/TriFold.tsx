...
const TriFold = () => {
  ...
  // FIX: Updated type definition to accept RefObject<HTMLDivElement | null>
  const downloadPageAsJPG = async (
    ...
    try {
      const canvas = await html2canvas(pageRef.current, {
        // ✅ x2 resolution increase for the downloaded JPEGs (page 1 & 2)
        // Previously: 2. Now: 4 (double the pixel density)
        scale: 4,
        useCORS: true,
        allowTaint: true,
        backgroundColor: '#ffffff',
        // FIX: Added scroll and sizing options to prevent warping
        scrollX: 0,
        scrollY: 0,
      });
  ...
  const PanelHeader = ({
    ...
    >
      ...
      <h3 className="font-bold uppercase tracking-wider text-gray-800 text-sm">
        {title}
      </h3>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-gray-200 flex flex-col items-center py-10 font-sans">
      ...
      <div
        ref={componentRef}
        className="w-[297mm] bg-white shadow-2xl overflow-hidden text-xs leading-relaxed"
      >
        {/* ================= SIDE 1: OUTER SIDE ================= */}
        ...
        <div ref={page1Ref} className="w-full h-[210mm] flex page-break">
            ...
            <div className="flex-1 flex flex-col justify-between">
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-bold text-[12px] text-gray-800">
                    Safety First
                  </h4>
                </div>
                <p className="text-[11px] text-gray-600 leading-relaxed">
                  Every La Necar driver is carefully vetted, trained, and
                  CPR-certified. With specialized expertise in behavioral and
                  communication support, our drivers ensure every rider is
                  treated with respect, dignity, and care.
                </p>
              </div>
              ...
              >
                ...
                <p className="text-[11px] text-gray-600 leading-relaxed">
                  La Necar provides real-time ride monitoring and instant ride
                  updates on pickup & drop-off, keeping families confident and
              ...
              >
                ...
                <p className="text-[11px] text-gray-600 leading-relaxed">
                  We offer round-the-clock transportation coverage ensuring
                  every rider gets where they need to be safely and on time.
                </p>
              </div>
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-bold text-[12px] text-gray-800">
                    Wheelchair Accessibility & Sensory Aware
                  </h4>
                </div>
                <p className="text-[11px] text-gray-600 leading-relaxed">
                  La Necar provides inclusive and comfortable transportation for
                  every mobility need, helping your loved one travel with
              ...
              >
                ...
                <p className="text-[11px] text-gray-600 leading-relaxed">
                  La Necar Logistics LLC achieved 85% driver retention over the
                  past two years. Consistency your loved one can count on.
                </p>
              </div>
            </div>

            <div className="mt-4 pt-3 border-t border-gray-200 text-[10px] text-gray-500 text-center italic">
              A DDD-approved provider serving NJ and surrounding areas.
            </div>
          </div>
          ...
          >
            ...
            <div className="flex-grow flex flex-col justify-center items-center text-center p-8 z-10">
              <div className="w-36 h-36 bg-white rounded-full flex items-center justify-center mb-10 p-3">
                {/* FIX: Replaced img with div background to prevent stretching in html2canvas */}
                <div
              ...
              <div className="w-full space-y-5">
                <div className="bg-white/15 backdrop-blur-md p-5 rounded-xl flex items-center gap-4 text-white border border-white/20">
                  ...
                  <div className="text-left">
                    <div className="text-[11px] opacity-70 uppercase font-semibold">
                      Call Us 24/7
                    </div>
                ...
                <div className="bg-white/15 backdrop-blur-md p-5 rounded-xl flex items-center gap-4 text-white border border-white/20">
                  ...
                  <div className="text-left">
                    ...
                    <div className="font-bold text-sm">
                      services@lanecarlogisticsllc.com
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="w-1/3 h-full relative flex flex-col bg-white">
            {/* Hero Image Top Half */}
            {/* FIX: Changed img to div background to fix html2canvas capture/warping */}
            ...
            <div className="h-[50%] p-6 flex flex-col">
              ...
              <div>
                ...
                <h2 className="text-lg font-bold text-gray-800 leading-tight">
                  What Families and Caregivers Must Know Before Selecting a
                  Provider
                </h2>
              </div>
              ...
              <div className="flex-1 flex items-center py-4">
                <div
                  className="p-4 bg-gray-50 border-l-4 w-full"
                  style={{ borderColor: brand.primary }}
                >
                  <h3
                  ...
                  >
                    Transportation Isn't Just a Ride
                  </h3>
                  <p className="text-gray-600 text-[11px] italic leading-relaxed">
                    "For the loved one you support, every trip is an opportunity
                    to participate in daily life safely and with dignity. This
                    brochure is designed to help families make confident
                    decisions when arranging transportation for individuals with
                    IDD."
                  </p>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="text-right flex flex-col justify-center">
                  <p className="text-[11px] text-gray-500 font-bold uppercase tracking-widest">
                    La Necar Logistics LLC
                  </p>
                  <p className="text-[10px] text-gray-400">
                    www.lanecarlogisticsllc.com
                  </p>
                </div>
              </div>
            </div>
        ...
        <div ref={page2Ref} className="w-full h-[210mm] flex page-break bg-white">
          ...
          <div className="w-1/3 h-full p-6 border-r border-gray-100 flex flex-col">
            ...
            <p className="text-[11px] text-gray-500 mb-4">
              Essential Criteria for ensuring safety and dignity in IDD
              transportation.
            </p>
            ...
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h4 className="font-bold text-sm" style={{ color: brand.primary }}>
                  1. DDD-Approved, Specialized Drivers
                </h4>
              </div>
              <p className="text-[11px] text-gray-600 mb-2 leading-relaxed">
                Safe, dignified transportation begins with ensuring drivers are
                vetted and trained to:
              </p>
              <ul className="space-y-0.5 ml-1">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-[10px] text-gray-500">
                    Recognize and respond to diverse communication needs,
                ...
                <li className="flex items-start gap-2">
                  ...
                  />
                  <span className="text-[10px] text-gray-500">
                    Manage anxiety, behavioral challenges, or sensory
                    sensitivities professionally and calmly
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2
                  ...
                  />
                  <span className="text-[10px] text-gray-500">
                    Ensure consistent routines during transit to reduce stress
            ...
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h4 className="font-bold text-sm" style={{ color: brand.primary }}>
                  2. Driver Retention & Consistency
                </h4>
              </div>
              <p className="text-[11px] text-gray-600 leading-relaxed">
                Consistency supports predictable routines for your loved one.
                Look out for providers with high driver retention rates, as this
                often leads to smoother trips and greater confidence for
                families.
              </p>
            </div>
            ...
            <div className="mb-3">
              ...
              <p className="text-[11px] text-gray-600 mb-2 leading-relaxed">
                Knowing where your child is in transit, and who to contact when
                you have a concern is real peace of mind. Ensure providers can
                deliver:
              </p>
              <ul className="space-y-0.5 ml-1">
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  ...
                  />
                  <span className="text-[10px] text-gray-500">
                    Instant pickup/drop-off notifications
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle2
                  ...
                  />
                  <span className="text-[10px] text-gray-500">
                    Direct communication with drivers and live support staff
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="mt-auto">
              <div className="h-24 relative overflow-hidden rounded-lg mb-2">
                {/* FIX: Changed img to div background to fix stretch/warp on download */}
                <div
                  className="w-full h-full bg-cover bg-center"
                  style={{ backgroundImage: `url(${images.caring})` }}
                  role="img"
                  aria-label="La Necar caring service"
                />
              ...
              <p className="text-[9px] text-gray-600 text-center leading-relaxed">
                A DDD-approved provider serving NJ and its environs. We provide
                trusted transportation for school, work, medical appointments,
          ...
          <div className="w-1/3 h-full p-6 border-r border-gray-100 flex flex-col bg-gray-50/50">
            ...
            <div className="w-full mb-6">
              <h3
                className="text-lg font-bold uppercase tracking-widest mb-4 text-center"
                style={{ color: brand.primary }}
              >
                Our Impact
              </h3>
              <div className="grid grid-cols-3 gap-3">
                <div
                  className="text-center rounded-xl px-4 py-2 shadow-sm"
                  style={{ backgroundColor: brand.primary }}
                >
            ...
            <div className="mb-5">
              ...
              <p className="text-[11px] text-gray-600 mb-2 leading-relaxed">
                Transportation should accommodate both the physical and sensory
                needs of your loved one. When evaluating providers, consider
                whether they offer:
              </p>
              <ul className="space-y-2 ml-1">
                ...
                <li className="flex items-start gap-2">
                  ...
                  />
                  <span className="text-[10px] text-gray-500">
                    Sensory-friendly interiors, including climate control and
                    reduced noise
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  />
                  <span className="text-[10px] text-gray-500">
                    Regular safety inspections to ensure dependable service
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="mb-5">
              ...
              <p className="text-[11px] text-gray-600 leading-relaxed">
                Even with careful planning, challenges can occur during transit.
                Select a provider with a responsive support team, capable of
          ...
          <div className="w-1/3 h-full p-6 flex flex-col">
            ...
            <div className="mb-4">
              <div className="relative bg-blue-50 p-5 rounded-xl">
                ...
                <p className="text-[12px] text-gray-700 italic mb-3 leading-relaxed relative z-10">
                  "As a parent, I genuinely appreciate the exceptional kindness,
                  patience and care my child receives from her driver. She
                  consistently ensures my daughter feels safe and supported.
                  This gives me peace of mind."
                </p>
                <p className="font-bold text-[11px]" style={{ color: brand.primary }}>
                  - Dad, NJ
                </p>
              </div>
            </div>
            ...
            <div className="mb-4">
              <div className="relative bg-amber-50 p-5 rounded-xl">
                <Quote
                  size={24}
                  className="text-amber-200 absolute top-3 right-3"
                />
                <p className="text-[12px] text-gray-700 italic mb-3 leading-relaxed relative z-10">
                  "I'm very grateful to the driver for her punctuality and how
                  she handles my daughter during rides. She manages my
                  daughter's behavior with care."
                </p>
                <p className="font-bold text-[11px]" style={{ color: brand.secondary }}>
                  - Mom, NJ
                </p>
              </div>
            </div>
            ...
            <div className="mb-4">
              <div className="relative bg-blue-50 p-5 rounded-xl">
                <Quote size={24} className="text-blue-200 absolute top-3 right-3" />
                <p className="text-[12px] text-gray-700 italic mb-3 leading-relaxed relative z-10">
                  "I'm so satisfied with La Necar transportation. The driver is
                  always on time to pick up my child, both at home and at the
                  program, which makes things so much smoother."
                </p>
                <p className="font-bold text-[11px]" style={{ color: brand.primary }}>
                  - Mom, NJ
                </p>
